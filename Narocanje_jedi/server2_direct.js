...
const server = new grpc.Server();
 ...
 async function GetAllRows(call, callback) {
    try {
  ...
  async function CreateUser (call, callback){
    ...
    async function  updateZaloga (call, callback) {
   ...
   async function  getAllMeals (call, callback) {
    try {
   ...
   async function  getIdByUsername (call, callback) {
 ...
 async function  createInBetween (call, callback)  {
...
server.addService(greeterPackage.Greeter.service, { GetAllRows: GetAllRows });

server.addService(greeterPackage.Greeter.service, 
{ CreateUser: CreateUser });
server.addService(greeterPackage.Greeter.service, 
{ updateZaloga: updateZaloga });
server.addService(greeterPackage.Greeter.service, 
{ getIdByUsername: getIdByUsername });
server.addService(greeterPackage.Greeter.service, 
{ getAllMeals: getAllMeals });
server.addService(greeterPackage.Greeter.service, 
{ createInBetween: createInBetween });
